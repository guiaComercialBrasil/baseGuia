...
def getCity(request, *args, **kwargs):
    ...
    try:
        # COMMENTING THIS OUT TO DISABLE IP-BASED GEOLOCATION FOR THE TIME
        ...
        # ADDING THIS BIT SO THAT CITY ALWAYS DEFAULTS TO 'MAIRIPORÃ' (UNLESS CITY IS SET ON SESSION - THAT'S TREATED ABOVE).
